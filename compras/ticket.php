...
// 3. CONSULTA DE ENCABEZADO (Compra + Proveedor)
...
// Ajusta 'productos_compras' si tu tabla intermedia se llama diferente
...
<head>
    ...
    <title>Ticket #<?php echo $info['id_compras']; ?></title>
    <link rel="stylesheet" href="ticket.css"> 
    <style>
        /* Ajustes para que se vea bien al abrirlo directo */
        body { background-color: #555; display: flex; justify-content: center; padding-top: 20px; }
        .ticket-modal { position: relative; display: block; width: 350px; background: white; padding: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.5); }
        .modal-header, .modal-actions { display: none; } /* Ocultamos botones de cerrar viejos */
        @media print {
            body { background: white; padding: 0; }
            .ticket-modal { box-shadow: none; width: 100%; }
            #btn-imprimir-pantalla { display: none; }
        }
    </style>
</head>
<body>
