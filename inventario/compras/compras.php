...
<head>
    ...
    <link rel="stylesheet" href="compra.css"> <link href="https://fonts.googleapis.com/css2?family=Oswald:wght@200..700&display=swap" rel="stylesheet">
...
<body>
    ...
    <div class="informacion">
        <div class="cuadro1">
            ...
            <p id="kpi_total_compras"><?php echo $total_global_registros; ?></p>
            <p><?php echo $total_global_unidades; ?> unidades compradas</p>
        </div>
        <div class="cuadro2">
            <span class="icono-dolar">$</span>
            <h2>Monto total</h2>
            <p id="kpi_monto_total">$<?php echo number_format($total_global_ingresos, 2); ?></p>
            <p>Valor total estimado</p>
        </div>
        <div class="cuadro3">
            <span class="icono-dolar"><i class="fas fa-chart-line"></i></span>
            <h2>Promedio</h2>
            <p id="kpi_promedio">$<?php echo number_format($promedio_global, 2); ?></p>
    ...
    <script src="comprasPDF.js"></script>
