function generarPDF() {
    ...
    const valTotalVentas = document.getElementById('kpi_total_ventas') ? document.getElementById('kpi_total_ventas').innerText : "0";
    ...
    pdf.text("REPORTE DE VENTAS", MARGEN_IZQUIERDO, 25);
    ...
    dibujarKPI(currentX, "TOTAL VENTAS", valTotalVentas);
    currentX += anchoCuadro + gap;

    dibujarKPI(currentX, "MONTO TOTAL", valMontoTotal);
    currentX += anchoCuadro + gap;

    dibujarKPI(currentX, "PROMEDIO / VENTA", valPromedio);
