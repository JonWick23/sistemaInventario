<?php
    ...
    // Filtro SQL (ID Compra o Nombre Proveedor)
    $filtro = "";
    if($busqueda != ''){
...
<body>
    ...
    <div class="table-container" id="tabla1">
        <table>
            <thead>
                <tr>
                    <th>ID COMPRA</th><th>ID PROVEEDOR</th><th>NOMBRE PROVEEDOR</th><th>SUBTOTAL</th><th>IVA</th><th>TOTAL</th><th>FECHA COMPRA</th><th class="acciones">ACCIONES</th>
                </tr>
            </thead>
                    ...
                    <?php foreach($compras as $c): ?>
                        <tr>
                            ...
                            <td class="celda-acciones">
                                ...
                                <button class="btn-pdf" data-id="<?php echo $c['id_compras']; ?>"><i class="fas fa-file-pdf"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
