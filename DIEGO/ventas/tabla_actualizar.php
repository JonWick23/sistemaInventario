<?php
    ...
    try {
        ...
        // 1. Recibir variables de JS
        $por_pagina = 10; 
        $pagina = isset($_GET['pagina']) ? (int)$_GET['pagina'] : 1;
        $busqueda = $_GET['busqueda'] ?? ''; // <--- Aquí recibimos lo que escribiste
        ...
        // --- AQUÍ ESTÁ LA MAGIA DEL BUSCADOR (ID O NOMBRE) ---
        if($busqueda != ''){
        ...
        if($busqueda != '') {
            // Ponemos los signos % para que busque coincidencias parciales
