...
// 3. CONSULTA DE ENCABEZADO
// Usamos 'fecha_venta' y nombre del cliente
...
// Usamos cantidad y precio de ventas_productos
...
<head>
    ...
    <title>Ticket Venta #<?php echo $info['id_ventas']; ?></title>
...
<body>
    ...
    <div class="ticket-modal">
        ...
        <div class="modal-actions">
             <button onclick="window.print()" style="margin-top:20px; padding:10px;">Imprimir Ticket</button>
        </div>
    </div>

    <script>
        // Manda a imprimir automáticamente al abrir
